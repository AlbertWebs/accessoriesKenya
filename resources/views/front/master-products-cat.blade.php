...
<head>
   ...
   <meta property="og:title" content="{{$page_name}} - {{$page_name}} Best Prices in Kenya | Accessories Kenya" />
   <meta property="og:description" content="{{$page_name}} - {{$page_name}} Best Prices in Nairobi">
   <meta property="og:url" content="{{url('/')}}/products/{{$page_name}}" />
